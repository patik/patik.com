...
// @include     https://*.tripadvisor.com/ShowTopic*
// @author      Craig Patik
// @namespace   https://patik.com/code/user-scripts/
// @homepageURL https://patik.com/code/user-scripts/
// @updateURL   https://patik.com/code/user-scripts/readable-trip-advisor.user.js
// @version     v20120407.1
// ==/UserScript==
...
el.type = 'text/css'
el.rel = 'stylesheet'
el.href = 'https://patik.com/code/user-scripts/readable-trip-advisor.css'
el.media = 'screen'
hd.appendChild(el)

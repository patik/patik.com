...
- **Three fixes in the past two weeks** on this mechanism alone: JIRA-4955 (extend restoration to the checkout page, merged June 1), the checkout paywall back-navigation fix (PR #12324, merged June 10), and JIRA-4968 (back button lands on the wrong page, in progress).

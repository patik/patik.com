	...
	<table class="text">
		...
		<tr>
			<td>
				...
				<p><span style="color:red;"><b>Update:</b></span> (7/23/04) This guide was posted in the <a href="http://forums.mozillazine.org/viewtopic.php?t=55195">Mozillazine.org forums</a> when I first wrote it. Since then, John Haller started the <a href="http://johnhaller.com/jh/mozilla/portable_firefox/">Portable Mozilla</a> project which not only makes this tutorial more simple, but it's a better solution for those wanting to run Firefox from a USB drive. The old tutorial can be found <a href="../../guides/mozilla/ffram_old.php">here</a>.</p>

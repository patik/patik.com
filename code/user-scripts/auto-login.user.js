...
// @include        http*://developer.mozilla.org/en*
// @namespace      http://patik.com/code/user-scripts/
// @homepageURL    http://patik.com/code/user-scripts/
// @updateURL      http://patik.com/code/user-scripts/auto-login.user.js
// ==/UserScript==
...
try {
  ...
  // Stack Overflow
  //
  if (wlh.indexOf("http://stackoverflow.com/question") > -1) {

...
var adnenh = (function _adnenh (win) {
  var postButton, textarea, adnCharDisplay, twCharDisplay,
      twchar = {},
      rpl = {},
      img = {};
  ...
  twchar.setup = function _twchar_setup () {
    ...
    if (!adnCharDisplay) { return false; }
  ...
  rpl.addRpLink = function _rpl_addRpLink (p) {
    ...
    rpLink.innerHTML = '<a href="#" data-adnenh-repost-link data-adnenh-repost-link-event><i class="icon-share-alt icon-share-adnenh-repost"></i> Quote</a>';

  ...
  <div id="turkey-main" role="main">
    ...
    <div class="intro">
      <p>We visited Turkey in mid-July 2009 for 14 days. While the sights ranged from beautiful to amazing, we were most fond of the delicious food and wonderful people.</p>
			<p>I wrote a few <a href="http://patik.com/blog/category/turkey/">blog posts</a> about the trip.</p>
    </div>
    ...
    <section>
      ...
      <ul>
        <li><strong>Istanbul</strong>
          <ul>
            <li>Sultanahmet: <a href="http://en.wikipedia.org/wiki/Hagia_Sophia">Hagia Sophia</a>, <a href="http://en.wikipedia.org/wiki/Sultan_Ahmed_Mosque">Blue Mosque</a>, <a href="http://www.cemberlitashamami.com.tr/html/en">&Ccedil;emberlita&#351; Hamami</a>, Grand Bazaar, and the <a href="http://en.wikipedia.org/wiki/Rock'n_Coke">Rock'n Coke Festival</a></li>
            <li>Beyo&#287;lu: Taksim Square, Istiklal Caddesi, Galata Bridge, Galata Tower</li>
            <li>Kad&#305;k&ouml;y: open markets, <a href="http://en.wikipedia.org/wiki/%C5%9E%C3%BCkr%C3%BC_Saraco%C4%9Flu_Stadium">Fenerbah&ccedil;e stadium</a></li>
            <li>Bosphorus Strait and <a href="http://en.wikipedia.org/wiki/Yoros_Castle">Anadolu Kava&#287;&#305;</a></li>
          </ul>
        </li>
        <li><a href="http://en.wikipedia.org/wiki/Cappadocia"><strong>Cappadocia</strong></a>: <a href="http://en.wikipedia.org/wiki/G%C3%B6reme">G&ouml;reme</a>, Fairy Chimneys</li>
        <li><a href="http://en.wikipedia.org/wiki/%C3%87%C4%B1ral%C4%B1"><strong>&Ccedil;&#305;ral&#305;</strong></a>: the unspoiled beach, the ruins of Olympos, and the fiery Chimeras</li>
        <li><a href="http://en.wikipedia.org/wiki/Ephesus"><strong>Ephesus</strong></a> and the town of Sel&ccedil;uk</li>
      </ul>

      <div class="travel-map">
      	<a href="../../img/turkey-overview-map.jpg"><img src="../../img/turkey-overview-map-small.jpg" alt="Photos of the places we visited superimposed on a map." title="Click for a larger version"></a>
      </div>
    </section>
    <?php /*
    <!--
    ...
    <section>
      <ul class="travel-page-links">
        <li><a href="../britain-benelux/">Britain &amp; Benelux 2012</a></li>
        <li><a href="../peru-argentina/">Peru &amp; Argentina 2011</a></li>
        <li><a href="../spain/">Spain 2010</a></li>
        <li><a href="../turkey/" class="selected">Turkey 2009</a></li>
        <li><a href="../germany/">Germany &amp; Austria 2008</a></li>
        <li><a href="../greece/">Greece 2007</a></li>
        <li><a href="../paris/">Paris 2005</a></li>
        <li><a href="../france/">France 2000</a></li>
      </ul>
    </section>

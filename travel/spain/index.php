...
function print_page_body()
{
  ...
  <style>
  	/ * Florante at Laura
     * @vendor:     Nyek! Pinoy Komik Fonts
     * @vendorurl:  http://www.edgartadeo.com/nyekfonts/index.shtml
     * @licenseurl: http://www.fontsquirrel.com/license/Florante-at-Laura
     * /
    @font-face {
      font-family: 'FloranteatLauraRegular';
      src: url('/font-face/florante-at-laura/FLORLRG_.eot');
      src: local('Florante at Laura Regular'), local('FloranteatLaura'), url('/font-face/florante-at-laura/FLORLRG_.ttf') format('truetype'), url('/font-face/florante-at-laura/FLORLRG_.woff') format('woff');
    }
    #spain-main h1, h2, h3 { font-family: 'FloranteatLauraRegular'; }
  </style>
  */ ?>
